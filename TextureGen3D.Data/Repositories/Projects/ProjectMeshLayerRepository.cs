...
namespace TextureGen3D.Data.Repositories.Projects
{
    public class ProjectMeshLayerRepository : IProjectMeshLayerRepository
    {
        ...
        public async Task<ProjectMeshLayer> CreateAsync(ProjectMeshLayer layer)
        {
            ...
            const string query = @"
                INSERT INTO public.""ProjectMeshLayers"" (""Id"", ""ProjectId"", ""ProjectMeshId"", ""Name"", ""Index"", ""CameraAngle"", ""Visible"", ""Inpaint"", ""Generated"", ""ReferenceId"", ""Created"")
                VALUES (@Id, @ProjectId, @ProjectMeshId, @Name, @Index, @CameraAngle, @Visible, @Inpaint, @Generated, @ReferenceId, @Created)
                RETURNING *";
